...
/*!
2-dimensional circle arc, points to its begin-end extremities through the pointers contained in its
...
public:
	...
	*/
	typedef enum {
					geol_ArcClockwise,				/// Clockwise arc
					geol_ArcCounterClockwise		/// Counterclockwise arc
				 } GEOL_ArcVersus;
...
*/
inline double GEOL_Arc::radius() const {
	return fabs(mRadius);
}
...
*/
inline double GEOL_Arc::length() const {
	return mLength;
}
